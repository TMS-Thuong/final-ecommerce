<template>
  <div class="relative" ref="searchContainerRef">
    <form ref="formRef" :class="[width, 'mx-auto', $attrs.class]" @submit.prevent="onSubmit">
      ...
      <div class="relative w-full">
        ...
        <input type="search" id="default-search" v-model="searchQuery" :placeholder="placeholder"
          @focus="showResults = true" :class="[
            'block w-full py-2 px-4 ps-14 text-lg border rounded-lg focus:ring-neutral-50 focus:border-neutral-500 hover:border-neutral-400',
            bgColor,
            textColor,
            placeholderColor,
            inputClass,
    ...
    <div v-if="showResults && (loading || searchResults.length > 0)"
      ...
      <ul v-else class="divide-y divide-gray-200">
        <li v-for="product in searchResults" :key="product.id" class="py-2 cursor-pointer hover:bg-gray-50"
